...
public final class OopsieStatementLogEntry {
    ...
    @NonNull
    private final OopsieLogEntryKind kind;
    @Nullable
    ...
    public OopsieStatementLogEntry(
            @NonNull OopsieLogEntryKind kind,
    ...
    @NonNull
    public OopsieLogEntryKind kind() {
        return kind;
    }
    ...
    public boolean equals(Object obj) {
        ...
        OopsieStatementLogEntry that = (OopsieStatementLogEntry) obj;
